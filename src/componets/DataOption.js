...
export const DataOption = () => {
    return (
        <>
            ...
            <div id="userComment" className="text-center">
            </div>
        </>
    )
}
var showData = (e) => {
    ...
    for (let i = 0; i < comments.length; i++) {
        ...
        document.getElementById("userComment").innerHTML += `<Card><Card.Header as="h5">${comment.name}</Card.Header><Card.Body><Card.Title>${comment.postId}</Card.Title><Card.Text>${comment.body}</Card.Text><Button variant="primary">Read More</Button></Card.Body></Card><br/>`
